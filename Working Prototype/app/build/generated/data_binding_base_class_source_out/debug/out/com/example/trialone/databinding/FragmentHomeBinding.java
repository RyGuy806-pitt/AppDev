...
public final class FragmentHomeBinding implements ViewBinding {
  ...
  private FragmentHomeBinding(@NonNull ConstraintLayout rootView, @NonNull Button Btn,
      @NonNull TextView Instructions) {
  ...
  public static FragmentHomeBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new FragmentHomeBinding((ConstraintLayout) rootView, Btn, Instructions);
    }
